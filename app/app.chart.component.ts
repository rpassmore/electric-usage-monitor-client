...
@Component({
  ...
  <div class="col-md-6">
		<div style="display: block;">      
			<canvas baseChart width="200" height="200" [datasets]="lineChartData" [labels]="lineChartLabels" [options]="lineChartOptions"
...
export class ElecChartComponent implements OnInit {
  // lineChart 
